...
export default function dashboard() {
  return (
    <main className="w-[100vw] h-[100vh] bg-[#f9f9f9] flex flex-col fixed">
      <header className="w-[100%] bg-white h-[15%] flex flex-row items-center justify-between bg-transparent px-10">
        <div id="left">
          <svg
            width="210"
            height="65"
